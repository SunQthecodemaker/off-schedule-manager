...
import { renderScheduleManagement } from './schedule.js?v=20260703a';
import { assignManagementEventHandlers, getManagementHTML, getDepartmentManagementHTML, getLeaveListHTML, getLeaveManagementHTML, handleBulkRegister, getLeaveStatusHTML, addLeaveStatusEventListeners, formatLeaveChange, reconcileHolidayLeaves } from './management.js?v=20260703a';
import { renderDocumentReviewTab, renderTemplatesManagement } from './documents.js?v=20260703a';
import { renderEmployeePortal, getManagerPerm } from './employee-portal-final.js?v=20260703a';
import { renderMobileAdminPortal } from './mobile-admin.js?v=20260703a';
import { loadPendingChanges, approvePendingChange, rejectPendingChange, approveAllPending, rejectAllPending } from './staging.js?v=20260703a';
import { renderWelfareTab } from './welfare-ui.js?v=20260703a';
