import { state, db } from './state.js?v=20260502f';
import { _, _all, show, hide } from './utils.js';
import { renderScheduleManagement } from './schedule.js?v=20260502f';
import { assignManagementEventHandlers, getManagementHTML, getDepartmentManagementHTML, getLeaveListHTML, getLeaveManagementHTML, handleBulkRegister, getLeaveStatusHTML, addLeaveStatusEventListeners } from './management.js?v=20260502f';
import { renderDocumentReviewTab, renderTemplatesManagement } from './documents.js?v=20260426a';
import { renderEmployeePortal, getManagerPerm } from './employee-portal-final.js?v=20260502f';
