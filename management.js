...
export function getManagementHTML() {
    ...
    const rows = employees.map(emp => {
        ...
        const managementButtons = `
            <button class="btn btn-primary btn-sm" onclick="handleUpdateEmployee(${emp.id})">저장</button> 
            <button class="btn btn-danger btn-sm ml-1" onclick="handleDeleteEmployee(${emp.id})">삭제</button>
        `;
        ...
        return `<tr class="border-t">
            ...
            <td class="p-2 text-center"><button class="btn btn-secondary btn-sm">재설정</button></td>
    ...
    const newRow = `
        <tr class="border-t bg-gray-50">
            ...
            <td class="p-2"></td>
            <td class="p-2 text-center"><button class="btn btn-primary btn-sm w-full" onclick="handleAddEmployee()">추가</button></td>
        </tr>`;
