...
// =========================================================================================
import { state, db, isVisibleIn } from './state.js?v=20260828a';
import { _ } from './utils.js';
import { buildLeaveMonthSectionsHTML } from './management.js?v=20260828a';
import { renderEmployeeMobileScheduleList } from './employee-portal-final.js?v=20260828a';
import { getLeaveDetails, isLeaveInPeriod } from './leave-utils.js?v=20260828a';
import { loadConfig, loadAllRecords, computeRemaining, elapsedMonthList, formatNum } from './welfare.js?v=20260828a';
