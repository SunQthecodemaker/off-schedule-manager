...
import { buildLeaveMonthSectionsHTML } from './management.js?v=20260825d';
import { renderEmployeeMobileScheduleList } from './employee-portal-final.js?v=20260825d';
import { getLeaveDetails, isLeaveInPeriod } from './leave-utils.js?v=20260825d';
import { loadConfig, loadAllRecords, computeRemaining, elapsedMonthList, formatNum } from './welfare.js?v=20260825d';
