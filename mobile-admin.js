...
import { buildLeaveMonthSectionsHTML } from './management.js?v=20260904a';
import { renderEmployeeMobileScheduleList } from './employee-portal-final.js?v=20260904a';
import { getLeaveDetails, isLeaveInPeriod } from './leave-utils.js?v=20260904a';
import { loadConfig, loadAllRecords, computeRemaining, elapsedMonthList, formatNum } from './welfare.js?v=20260904a';
