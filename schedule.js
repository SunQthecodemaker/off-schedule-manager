import { state, db, isVisibleIn, getEmployeeStatus, isAlbaEmployee, isTestEmployee, sortByDeptOrder } from './state.js?v=20260904a';
...
import { registerManualLeave } from './management.js?v=20260904a';
import { getKoreanHolidaysOfMonth, hasHolidayData, findKoreanHoliday } from './holidays-kr.js?v=20260904a';
import { syncToAppSheet, importFromAppSheet, getScriptUrl, setScriptUrl } from './appsheet-client.js?v=20260904a';
