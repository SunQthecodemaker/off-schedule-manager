...
import { state, db, isTestEmployee } from './state.js?v=20260819a';
import {
...
} from './welfare-consent.js?v=20260819a';
import { renderBoardAdminSection } from './welfare-board.js?v=20260819a';
