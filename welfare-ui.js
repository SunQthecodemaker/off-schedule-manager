...
import { state, db, isTestEmployee } from './state.js?v=20260819b';
import {
...
} from './welfare.js?v=20260819b';
import {
    generateConsentHTML, generateSettlementHTML, attachSignaturePad, printHTML,
} from './welfare-consent.js?v=20260819b';
import { renderBoardAdminSection } from './welfare-board.js?v=20260819b';
